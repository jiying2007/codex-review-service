...
- Review Receipt：**4**
- Safe Contract：**2**
- Safe Core：精确提交 `cd9788f1280a217fbe6d0beb59682a85a8b82c4d`
- Quality Platform：**3**
- Review Profile：**1**
- Profile Pack：**1**
- Impact Evidence：**2**
...
任一 profile 只要无法证明 diff 完整，就会在调用 Codex 前 fail closed。真实 Provider CI 覆盖 GitLab CE **14.6.1、17.11.7、19.3.0**。Safe Core 仍是 Family v4，Service v6.5 不改变共享 Review 协议。
...
优先把经过验证的 `codex-review-service-6.5.2.tgz` 安装到 `/opt/codex-review-service`。
