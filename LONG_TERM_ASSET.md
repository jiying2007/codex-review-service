...
30. The historic **Schema 5 -> 6** and **Schema 6 -> 7** migrations remain explicit and tested. Schema 8 adds the verified-backup, transactional **Schema 7 -> 8** status-card migration. After v5.0.0, database/config evolution requires explicit upgrade/migration fixtures/tests and a documented rollback boundary.
