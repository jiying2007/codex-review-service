...
Codex Review Service is maintained as a security- and reliability-sensitive platform component. Service **v7.5.2** is the current production-operations baseline; shared review/safety/Judgment Lifecycle/Runtime/Provider/Model Routing semantics remain exact-pinned Safe Core Family v4.

## Product identity

`product-contract.json` is the machine-checked product fact source: Service 7.5.2, Database Schema 8, Config Schema 8, Policy Schema 4, Review Receipt 5, Safe Contract 2, Runtime Contract 3, Provider Contract 3, Model Routing Contract 1, Profile Pack 1, Test Impact 1, Analyzer Adapter 1, Judgment Lifecycle 1, exact Safe Core commit `00403dd14877e978698c63d06f6dbdfe2ba9b8cc`, Node 22.22.2+/24.19.0+ LTS support and GitLab >=14.6.1 compatibility.
...
40. Current documentation must describe Service v7.5.2, Database Schema 8, Config Schema 8, Review Receipt 5, Runtime/Provider Contract v3, Model Routing Contract v1 and exact Safe Core 4.17.0 accurately; historical labels belong only in changelog/migration history.
