...
Codex Review Service **6.2.0** is the current production-operations baseline. Machine-readable identity lives in `product-contract.json`:
...
From v5.0.0 onward, released DB/Config compatibility is a product contract. Service 6.2.0 introduces a **Config Schema 2 -> 3 hard cut** while retaining Database Schema 6. Before upgrade:
