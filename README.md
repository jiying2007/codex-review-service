...
- Review Receipt: **5**
- Safe Contract: **2**
- Safe Core: exact commit `786e3a3fc896e0e623af6fe63dbf814ddd09bad8`
- Quality Platform: **3**
- Review Profile: **1**
- Profile Pack: **1**
- Impact Evidence: **2**
...
Install the verified `codex-review-service-7.5.1.tgz` release artifact under `/opt/codex-review-service`, or check out the exact release tag only for development/audit. Then:
