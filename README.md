...
- Review Receipt: **4**
- Safe Contract: **2**
- Safe Core: exact commit `57440a00030941020d5c3e9e01ced3c06062f42e`
- Quality Platform: **3**
- Review Profile: **1**
- Profile Pack: **1**
- Impact Evidence: **2**
...
Install the verified `codex-review-service-6.5.0.tgz` release artifact under `/opt/codex-review-service`, or check out the exact release tag only for development/audit. Then:
